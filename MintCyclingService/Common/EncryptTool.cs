...
namespace MintCyclingService.Common
{
    ...
    public class EncryptTool
    {
        ...
        private static readonly string DefaultKey = "Leenwenhulk";
        ...
        /// <param name="encryptString">待加密的字符串</param>
        /// <returns></returns>
        public static string DefaultEncryptDES(string encryptString)
        {
        ...
        /// <param name="decryptString">待解密的字符串</param>
        /// <returns></returns>
        public static string DefaultDecryptDES(string decryptString)
        {
