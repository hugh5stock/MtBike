...
namespace MintCyclingService.WxJpush
{
    ...
    /// 极光推送实现类
    /// </summary>
    public class WxJpushService : IWxJpushService
    {
        /// <summary>
        /// 读取配置文件信息
        /// </summary>
        private readonly string ApiKey = ConfigurationManager.AppSettings["wxApp_Key"].ToString();                    //Android ApiKey
        private readonly string APIMasterSecret = ConfigurationManager.AppSettings["wxMaster_Secret"].ToString();    //Android密码
