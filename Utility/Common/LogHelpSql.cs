...
{
  public  class LogHelpSql
    {

       
            //数据库连接字符串(web.config来配置)
            //public static string connectionString = PubConstant.ConnectionString;
            public static string connectionString = ConfigurationManager.ConnectionStrings["MintBicycleLogConnectionString"].ToString();
            ...
            public LogHelpSql(string ConnectionString)
            {
